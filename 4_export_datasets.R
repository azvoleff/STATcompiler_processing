...
load("Merged_data/DHS_merged_data_surveys_by_country.Rdata")
...
save(regional_data, file="Merged_data/DHS_merged_data_regional.Rdata")
write.csv(regional_data, file="Merged_data/DHS_merged_data_regional.csv",
        row.names=FALSE, na=".")
...
write.csv(regional_data, file="Merged_data/DHS_merged_data_regional_Aoife+Laura.csv",
        row.names=FALSE, na=".")
...
#        file="Merged_data/DHS_merged_data_regional_lastsurvey.csv",
#        row.names=FALSE, na=".")
#save(regional_data_lastsurvey,
#        file="Merged_data/DHS_merged_data_regional_lastsurvey.Rdata")
...
write.csv(urban_rural_data,
        file="Merged_data/DHS_merged_data_urban_rural.csv",
        row.names=FALSE, na=".")
save(urban_rural_data, file="Merged_data/DHS_merged_data_urban_rural.Rdata")
...
#        file="Merged_data/DHS_merged_data_urban_rural_lastsurvey.csv",
#        row.names=FALSE, na=".")
#save(urban_rural_data_lastsurvey,
#        file="Merged_data/DHS_merged_data_urban_rural_lastsurvey.Rdata")
